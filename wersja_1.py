...
if zachowane_pieniadze != 0:
    ...
    zachowane_pieniadze = poziom_gry_cztery_zapadki(p3_miasta_wojewodzkie, p3_jedzenie, p3_zabytki, p3_znane_strony_internetowe, zachowane_pieniadze)
if zachowane_pieniadze != 0:
    ...
    zachowane_pieniadze = poziom_gry_cztery_zapadki(p4_muzyka_klasyczna, p4_religie, p4_literatura, p4_komputery, zachowane_pieniadze)
if zachowane_pieniadze != 0:
